...
class Pendingscreen extends StatefulWidget {
  ...
  @override
  State<Pendingscreen> createState() => _LivescreenState();
}

class _LivescreenState extends State<Pendingscreen> {
  final productCubit = ProductCubit();

  @override
  void initState() {
    super.initState();
    productCubit.getProduct(type: "pending");
  }
          ...
          child: BlocConsumer<ProductCubit, ProductState>(
            ...
            builder: (context, state) {
              switch (state.runtimeType) {
                case LoadingState:
                  return pendingProduct(isLoading: true);
  ...
  Widget pendingProduct({List<ProductData>? productItem, bool isLoading = false}) {
